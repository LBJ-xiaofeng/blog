            ...
            <div class="tpl-form-body tpl-form-line">
                <form class="am-form tpl-form-line-form" method="post" action="/admin/setting" enctype="multipart/form-data">
                    ...
                    <div class="am-form-group">
                        ...
                        <div class="am-u-sm-9">
                            <input type="text" {{$setting ? $setting->domain : ''}} name="domain" class="tpl-form-input" id="user-name" placeholder="">
                        </div>
                    </div>
                    ...
                    <div class="am-form-group">
                        ...
                        <div class="am-u-sm-9">
                            <input type="text" name="keywords" class="tpl-form-input" id="user-name" placeholder="">
                        </div>
                    </div>
